...
Reads  game-play-screenshots/heroes/<file>  for each entry in LAYOUT,
...
After re-slicing, bump PORTRAIT_VERSION in src/lib/portrait-version.ts so
...
SRC = "game-play-screenshots/heroes"
OUT = "public/heroes"
...
def write_seed(heroes):
    ...
    lines = [
        ...
        "/**", " * Roster sliced from in-game Archive screenshots (game-play-screenshots/heroes).",
